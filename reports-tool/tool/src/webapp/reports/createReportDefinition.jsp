...
<f:view>
    <sakai:view title="#{msgs.title_create_report_def}">
        <h:form>

            <sakai:view_title value="#{msgs.title_create_report_def}" indent="1"/>
            ...
            <sakai:group_box>
                ...
                <sakai:panel_edit>
                    ...
                    <sakai:rich_text_area value="#{ReportsTool.workingReport.report.description}" rows="10"
                                          columns="70"/>
